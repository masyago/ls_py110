...
#         if score['Player'] == 5 or score['Computer'] == 5:
#             break
            
#         prompt(f"CURRENT SCORE Player {score['Player']} : Computer {score['Computer']}")
        

# # def display_score(score):
# #     prompt(f"Current score: {score['Player']} - {score['Computer']}")
...
def play_game():
    while True:
        ...
        while True:
            player_input = int(input('Player, choose 1 or 0: '))
            computer_input = int(input('Computer, choose 1 or 0: '))
